...
class trainer:
	def __init__(self, data_path, label_path):
		...
		self.data_file_amount = len(os.listdir(data_path))
		self.label_file_amount = len(os.listdir(label_path))
	...
	def load_data(self, chunk):
		train_hum_numpy_array = self.data_processor.load_data_chunk(self.data_path, chunk)
		train_music_numpy_array = self.data_processor.load_label_chunk(self.label_path, chunk)
		val_hum_numpy_array, val_music_numpy_array = [0], [0]
