...
class trainer:
    ...
    def train_fn(
        ...
        for idx, (music, hum) in enumerate(loop):
            ...
            if idx % 50 == 0:
                save_image(fake_hum * 0.5 + 0.5, f"saved_images_hum/epoch_{epoch_num}_index_{idx}.png")
                save_image(fake_music * 0.5 + 0.5, f"saved_images_music/epoch_{epoch_num}_index_{idx}.png")
